  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      ...
      <div className="carousel-caption d-block">
        ...
        <a className="btn btn-primary" href={proyecto_uno.repo} role="button" target="_blank" rel="noopener noreferrer">Repository</a>
        <a className="btn btn-primary" href={proyecto_uno.demo} role="button" target="_blank" rel="noopener noreferrer">Demo</a>
      </div>
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-block">
        ...
        <a className="btn btn-primary" href={proyecto_dos.repo} role="button" target="_blank" rel="noopener noreferrer">Repository</a>
        <a className="btn btn-primary" href={proyecto_dos.demo} role="button" target="_blank" rel="noopener noreferrer">Demo</a>
      </div>
    </div>
    <div className="carousel-item">
